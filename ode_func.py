    ...
    def __init__(self, last_wind_vars, num_units, latent_dim, adj_mx, edge_index, edge_attr, gcn_step, num_nodes,
        ...
        if(self._filter_type == "diff"):
            ...
            for i in range(batch_size):
                ...
                supports_adv.append(calculate_random_walk_matrix(adj_mx_new.detach().numpy()).T)
                supports_adv.append(calculate_random_walk_matrix(adj_mx_new.detach().numpy().T).T)
