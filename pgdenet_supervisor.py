# -*- coding: utf-8 -*-
"""pgdenet_supervisor.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/13f9QPea8AcqGFq11ZyvQjbyxVJvmaD9r
"""
...
from utils import *
from pgdenet_model import PGDENetModel
from metrics import *

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

class PGDENetSupervisor:
    def __init__(self, adj_mx, edge_index, edge_attr, **kwargs):
        ...
        # setup model
        pgdenet_model = PGDENetModel(adj_mx, edge_index, edge_attr, self._logger, **self._model_kwargs)
    ...
    def _get_log_dir(kwargs):
        ...
        if log_dir is None:
            ...
            run_id = 'pgdenet_%s_h_%d_lr_%g_bs_%d_%s/' % (filter_type_abbr, horizon, learning_rate, batch_size,time.strftime('%m%d%H%M%S'))
